-- Member roster boundary cleanup:
-- - LinkedIn is intentionally public in the member directory profile.
-- - member_since_term is intentionally not exposed because pledge_class is
--   the single roster concept for member class/start timing.

drop view if exists public.member_directory_profiles;

create view public.member_directory_profiles
