-- Campus housing is useful context, but not every active member lives in
-- university housing. Keep it editable/exportable without counting it as a
-- hard verification or Secretary Registry missing-info blocker.
...
set required_fields = array_remove(required_fields, 'campus_housing')
where 'campus_housing' = any(required_fields);
